...
===================================================================================== */
#ifndef __TCHEM_IGNITIONZERODNUMJACFWD_HPP__
#define __TCHEM_IGNITIONZERODNUMJACFWD_HPP__

#include "TChem_Util.hpp"
#include "TChem_KineticModelData.hpp"
#include "TChem_IgnitionZeroDNumJacobianFwd.hpp"
#include "TChem_Impl_IgnitionZeroDNumJacobianFwd.hpp"
...
struct IgnitionZeroDNumJacobianFwd
{
  ...
  {
    return Impl::IgnitionZeroDNumJacobianFwd<real_type,DeviceType>::getWorkSpaceSize(kmcd) + (kmcd.nSpec + 1);
  }
