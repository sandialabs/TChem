...
#include "TChem_NetProductionRateNcar.hpp"
...
namespace TChem {
  ...
  template<typename PolicyType,
           typename DeviceType>
void
NetProductionRateNcar_TemplateRun( /// input
  ...
  const KineticModelNCAR_ConstData<DeviceType >& kmcd)
{
  ...
  TChem::NetProductionRateNcar::getWorkSpaceSize(kmcd);
  ...
  Kokkos::parallel_for(
    ...
    KOKKOS_LAMBDA(const typename policy_type::member_type& member) {
                        ...
                        "Error: input state vector is not valid");
      {
        ...
        ::team_invoke(member, t, p, Ys, omega_at_i, ww,  kmcd);
...
void
NetProductionRateNcar::runHostBatch( /// input
  ...
  const kinetic_model_host_type& kmcd)
{
  ...
  NetProductionRateNcar_TemplateRun( /// input
    "TChem::NetProductionRateNcar::runHostBatch",
    policy,
    state,
    omega,
    kmcd);
...
void
NetProductionRateNcar::runDeviceBatch( /// input
  ...
  const kinetic_model_type& kmcd)
{
  ...
  NetProductionRateNcar_TemplateRun( /// input
    "TChem::NetProductionRateNcar::runDeviceBatch",
    policy,
    state,
    omega,
    kmcd);
...
NetProductionRateNcar::runDeviceBatch( /// input
  ...
  const kinetic_model_type& kmcd)
{
  Kokkos::Profiling::pushRegion("TChem::NetProductionRateNcar::runDeviceBatch");
