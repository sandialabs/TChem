...
===================================================================================== */
#ifndef __TCHEM_REACTION_RATES_NCAR_HPP__
#define __TCHEM_REACTION_RATES_NCAR_HPP__
...
struct NetProductionRateNcar
{
  ...
  {
    return Impl::ReactionRatesAerosol<real_type,DeviceType>::getWorkSpaceSize(kmcd);
  }
