...
===================================================================================== */
#ifndef __TCHEM_SpecificHeatCapacityConsVolumePerMass_HPP__
#define __TCHEM_SpecificHeatCapacityConsVolumePerMass_HPP__
...
struct SpecificHeatCapacityConsVolumePerMass
{
  template<typename KineticModelConstDataType>
  static inline ordinal_type getWorkSpaceSize(KineticModelConstDataType& kmcd)
  {
    return kmcd.nSpec; //
  }
