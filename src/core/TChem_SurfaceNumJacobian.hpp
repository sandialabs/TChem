...
===================================================================================== */
#ifndef __TCHEM_SURFACENUMJACOBIAN_HPP__
#define __TCHEM_SURFACENUMJACOBIAN_HPP__
...
struct SurfaceNumJacobinan
{
  ...
  {
    return (Impl::SurfaceNumJacobian::getWorkSpaceSize(kmcd, kmcdSurf));
  }
