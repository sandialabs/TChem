...
#ifndef __TCHEM_IMPL_NUMERICAL_JACOBIAN_CENTRAL_DIFFERENCE_HPP__
#define __TCHEM_IMPL_NUMERICAL_JACOBIAN_CENTRAL_DIFFERENCE_HPP__
    ...
    const RealType2DViewType& J)
  {
    ...
    for (ordinal_type j = 0; j < m; ++j) {
      ...
      Kokkos::parallel_for(
        ...
        [&](const ordinal_type& i) { J(i, j) = half * (f_h(i) - f_0(i)) / h; });
