#ifndef __TCHEM_IMPL_CONSTANT_VOLUME_IGNITION_REACTOR_HPP__
#define __TCHEM_IMPL_CONSTANT_VOLUME_IGNITION_REACTOR_HPP__
    ...
    const kinetic_model_type& kmcd)
  {
    ...
    if (dt_in > zero && dt_out() < zero) {
      Kokkos::single(Kokkos::PerTeam(member), [&]() {
        printf("Warning: ConstantVolumeIgnitionReactor sample id(%d) failed\n",
