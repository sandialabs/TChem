...
main(int argc, char* argv[])
{
  ...
  opts.set_option<int>("jacobian-interval",
                       "Jacobians evaluated once in this interval",
                       &jacobian_interval);
  opts.set_option<int>(
    "batchsize",
  ...
  Kokkos::initialize(argc, argv);
  {
    ...
    // //Run a newton solver to check constraints.
    ...
    if (initial_condition){
      ...
      tol_newton_host_initial_condition(0) = atol_newton;
      tol_newton_host_initial_condition(1) = rtol_newton;
